...
class CostomDataset(data.Dataset):
...
if __name__ == '__main__':
    datapath =  r'E:\github\PixelSSL-master\PixelSSL-master\task\sseg\dataset\PascalVOC\VOCdevkit\VOC2012'
    CostomDataset(datapath)
