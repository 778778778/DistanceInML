...
def main(args: argparse.Namespace) -> None:
    ...
    images_path = Path(args.images_path)  # Path('../../data/Cityscapes/leftImg8bit/train')
    # images_path = Path('../../data/Cityscapes/leftImg8bit/train')
    assert images_path.exists()
    # root path of Cityscapes data
    destiny_path = Path('../../data/Cityscapes_extra')
...
def get_args() -> argparse.Namespace:
    ...
    choices.add_argument('--images_path', type=str,
                         help='path to the unzipped leftImg8bit_trainextra folder of Cityscapes data', required=True)
